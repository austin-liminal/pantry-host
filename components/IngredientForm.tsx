...
import { CATEGORIES, UNIT_GROUPS, COMMON_INGREDIENTS } from '@/lib/constants';
  ...
  return (
    <form onSubmit={handleSubmit} aria-label={editing ? 'Edit ingredient' : 'Add ingredient'} noValidate>
      ...
      <fieldset className="mb-4">
        ...
        <div className="flex rounded border border-zinc-300 dark:border-zinc-600 overflow-hidden w-fit" role="group">
