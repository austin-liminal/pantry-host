...
export function registerIngredientTools(server: McpServer) {
  ...
  server.tool(
    ...
    'Add an ingredient to the pantry.',
    {
      ...
      category: z.enum(['vegetables', 'fruit', 'fresh herbs', 'dairy & eggs', 'meat & poultry', 'seafood & fish', 'eggs', 'tofu & tempeh', 'legumes & pulses', 'nuts & seeds', 'dry goods & grains', 'canned & jarred', 'condiments & sauces', 'herbs & spices', 'oils & vinegars', 'baking', 'frozen', 'deli & charcuterie', 'beverages', 'snacks', 'other']).optional().describe('Category'),
