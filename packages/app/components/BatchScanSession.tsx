    ...
    <Modal open={true} onClose={onCancel} title="Batch scan groceries" fullScreen>
        ...
        <div className="flex flex-col flex-1 overflow-hidden">
          ...
          <div className="shrink-0 flex gap-3 p-4 border-t border-[var(--color-border-card)]">
            <button
              type="button"
              onClick={onCancel}
              className="btn-secondary flex-1 border-[var(--color-border-card)] text-[var(--color-text-secondary)]"
            >
              Cancel
            </button>
            <button
      ...
      {phase === 'review' && (
        <div className="flex flex-col flex-1 overflow-hidden">
          ...
          <div className="shrink-0 flex gap-3 p-4 border-t border-[var(--color-border-card)]">
            <button type="button" onClick={() => setPhase('scanning')} className="btn-secondary flex-1 border-[var(--color-border-card)] text-[var(--color-text-secondary)]">
              ← Scan More
            </button>
            <button
              type="button"
