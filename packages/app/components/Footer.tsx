...
export default function Footer() {
  ...
  return (
    <footer className="no-print border-t border-[var(--color-border-card)] mt-16 pt-10 pb-8 px-4 sm:px-6 text-xs text-[var(--color-text-secondary)]">
      <div className="max-w-5xl mx-auto">
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 mb-8">
          <div>
            <h3 className="font-semibold text-[var(--color-text-secondary)] uppercase tracking-wider mb-3">Volume</h3>
          ...
          <div>
            <h3 className="font-semibold text-[var(--color-text-secondary)] uppercase tracking-wider mb-3">Weight</h3>
            <dl className="space-y-1">
          ...
          <div>
            <h3 className="font-semibold text-[var(--color-text-secondary)] uppercase tracking-wider mb-3">Temperature</h3>
            <dl className="space-y-1">
          ...
          <div>
            <h3 className="font-semibold text-[var(--color-text-secondary)] uppercase tracking-wider mb-3">Handy</h3>
            <dl className="space-y-1">
        ...
        <div className="border-t border-[var(--color-border-card)] pt-6 mt-2">
          <p className="font-serif font-bold text-sm text-[var(--color-text-secondary)]" style={{ fontFamily: "Iowan Old Style, Apple Garamond, Baskerville, Times New Roman, Droid Serif, Times, Source Serif Pro, serif, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol" }}>Pantry Host</p>
          <p className="mt-2 legible text-[var(--color-text-secondary)] pretty">
            An open source, self-hosted kitchen companion that runs entirely on your home network. Your recipes, your data, your&nbsp;machine.
          </p>
          <p className="mt-1.5 legible text-[var(--color-text-secondary)] pretty">
          ...
          <p className="mt-1.5 legible text-[var(--color-text-secondary)] pretty">
            Optionally enhanced by <a href="https://claude.ai/download" className="hover:underline text-[var(--color-text-secondary)]">Claude&nbsp;Code</a>&nbsp;&mdash; import recipes from any URL, generate new ones from what you have on hand, and manage your pantry conversationally. AI features require an API key and are entirely&nbsp;opt&#8209;in.
          </p>
          ...
          <div className="mt-6 flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <label className="flex items-center gap-1.5 select-none">
                ...
                <select
                  ...
                  className="text-xs bg-transparent border border-[var(--color-border-card)] rounded px-1.5 py-0.5"
            ...
            <a href="https://github.com/jpdevries/pantry-host" className="text-[var(--color-text-secondary)] hover:text-[var(--color-text-primary)] transition-colors" aria-label="Pantry Host on GitHub">
