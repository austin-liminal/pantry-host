function IconDocker({ size = 32 }: { size?: number }) {
  return (
...
function IconRaspberryPi({ size = 32 }: { size?: number }) {
  return (
    ...
    <section className="px-4 sm:px-6 py-16 sm:py-24 max-w-5xl mx-auto">
      ...
      <div className="max-w-xl mx-auto rounded-xl border border-[var(--color-border-card)] bg-[var(--color-bg-card)] p-5 font-mono text-sm leading-relaxed">
        <p className="text-[var(--color-text-secondary)]">
          <span className="select-none opacity-50">$ </span>git clone https://github.com/jpdevries/pantry-host.git
        </p>
        <p className="text-[var(--color-text-secondary)]">
          <span className="select-none opacity-50">$ </span>cd pantry-host
        </p>
        <p className="text-[var(--color-text-primary)]">
          <span className="select-none opacity-50">$ </span>docker compose up -d
        </p>
      </div>
      <p className="text-center text-xs text-[var(--color-text-secondary)] mt-6">
        Optional: pass <code className="font-mono">AI_API_KEY</code> to enable AI&nbsp;recipe&nbsp;generation.
      </p>
      <p className="text-center text-xs text-[var(--color-text-secondary)] mt-3">
        Add <a href="https://tailscale.com/" className="underline hover:text-[var(--color-text-primary)]" target="_blank" rel="noopener noreferrer">Tailscale</a> for
        free HTTPS&nbsp;&mdash; barcode scanner works on iOS at the grocery&nbsp;store.
      </p>
    </section>
  );
}
